...
\begin{center}
    \begin{tabular}{@{} p{5cm} p{5cm} p{5cm} @{}} % 3 colonnes avec largeurs fixées
        Lycée Dindéfélo & \quad\quad Test 6 & 28 Novembre 2025 \\
    \end{tabular}
...
\underline{\hspace{20cm}}
\question\
Enoncer le théorème des valeurs intermediaries et son corrolaire.\\
\underline{\hspace{20cm}}\\
\underline{\hspace{20cm}}\\
\underline{\hspace{20cm}}\\
\question Enoncer le théorème de L'IAF\\
\underline{\hspace{20cm}}\\
\underline{\hspace{20cm}}\\
\underline{\hspace{20cm}}\\
\end{document}